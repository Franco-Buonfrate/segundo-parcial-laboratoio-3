    ...
    .done(function (resultado:any) {
        ...
        if(resultado.exito)
        {
            ...
            $('[data-action="modificar-usuario"]').on('click', function (e) {
                ...
                $("#ventana_modal_prod").html(formulario);           
            });
...
{   
    ...
    else
    {
        juguetes.forEach((toy : any) => {
            ...
            tabla += "<td><a href='#' class='btn' data-action='modificar-usuario' data-obj_user='"+JSON.stringify(toy)+"' title='Modificar'"+
            " data-toggle='modal' data-target='#ventana_modal_prod' ><span class='fas fa-edit'></span></a>";
            tabla += "<a href='#' class='btn' data-action='eliminar-usuario' data-obj_user='"+JSON.stringify(toy)+"' title='Eliminar'"+
